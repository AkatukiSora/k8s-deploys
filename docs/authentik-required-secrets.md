...
| `authentik-blueprints-oidc`    | `authentik`  | `KUBERNETES_OIDC_CLIENT_SECRET`, `PROXMOX_OIDC_CLIENT_SECRET`, `ARGOCD_OIDC_CLIENT_SECRET`, `CODER_OIDC_CLIENT_SECRET`, `IMMICH_OIDC_CLIENT_SECRET`, `GRAFANA_OIDC_CLIENT_SECRET`, `NEXTCLOUD_OIDC_CLIENT_SECRET`, `GITLAB_OIDC_CLIENT_SECRET` | Authentik Blueprint provider secrets            |
